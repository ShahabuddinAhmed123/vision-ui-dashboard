...
const Dashboard: React.FC = () => {
  return (
    <div className="dashboard w-full h-auto p-6 relative overflow-y-auto z-0 pt-[110px] max-[768px]:pt-[130px] ml-[17.125rem] max-[1440px]:ml-0"
    style={{
      ...
      <DashLastComponent route="/dashboard"/>
      <Footer/>
    </div>
  );
}
