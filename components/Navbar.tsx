...
useEffect(() => {
  ...
  return (
    ...
    <div className='h-[75px] fixed bg-transparent z-50 w-[83%] max-[1650px]:w-[80%] backdrop-blur-xl py-2 top-3 rounded-2xl mx-auto border right-5 max-[1440px]:w-[97%] max-[768px]:h-auto max-[768px]:w-[98%] max-[768px]:right-2'>
      <div
     ...
     <Hamburger onClick={handleOpenSidebar}  isOpen={openSidebar}/>
